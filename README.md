...
```
kubectl run -i --tty load-generator --rm --image=busybox:1.36.0 --restart=Never -- /bin/sh -c "while sleep 0.01; do wget -q -O- https://asli-3000.theiaopenshiftnext-1-labs-prod-theiaopenshift-4-tor01.proxy.cognitiveclass.ai/; done"
```
...
## Contact
If you have any questions, please feel free to reach out via email: asli@gmail.com
<p align="right">(<a href="#readme-top">back to top</a>)</p>
